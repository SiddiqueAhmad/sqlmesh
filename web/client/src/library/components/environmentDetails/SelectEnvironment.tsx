    ...
    >
      {({ close }) => (
        <>
          ...
          >
            <div
              data-testid="select-environment-list"
              className="!mx-0 absolute top-10 right-0 min-w-[20rem] max-w-[100%] overflow-hidden shadow-2xl bg-theme border-0 border-neutral-100 dark:border-neutral-800 rounded-md flex flex-col z-10"
            >
